    ...
    <section id="advisors" className="py-24 bg-white relative scroll-mt-24">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <motion.div
          ...
          className="max-w-md mx-auto py-8 px-6 bg-tark-bg border border-tark-gold/20 rounded-2xl text-center"
        >
          <p className="text-tark-navy font-medium text-sm sm:text-base tracking-wide">
            Our board of patrons and advisors will be made public soon.
          </p>
        </motion.div>
